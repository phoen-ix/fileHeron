...
## Reference projects (precedent for patterns)

- `/home/mk/claude/prater-zeiterfassung-v2/` — `config.py` fail-fast, SQLAlchemy session, Dockerfile multi-stage, Pinia auth store + axios refresh interceptor.
