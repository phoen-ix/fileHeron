...
# ---- Share defaults (per-share notify-recipients checkbox default) -----


from ..schemas.share_defaults_settings import (  # noqa: E402
...
@router.get(
    "/settings/share-defaults", response_model=ShareDefaultsResponse
)
