...
REGISTRY: dict[str, CronSpec] = {
    s.name: s for s in [
        ...
        CronSpec("drain_pending_update", "ops",
                 ...
                 KIND_INTERVAL, 1),
        CronSpec("auto_update", "ops",
                 "Install a newer release automatically, if enabled on Status & updates.",
                 KIND_DAILY, default_daily_time="03:30"),
        CronSpec("announce_ready_shares", "shares",
                 "Notify recipients once a share's uploads have finished.",
                 KIND_INTERVAL, 1),
