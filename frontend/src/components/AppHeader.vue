<script setup lang="ts">
  ...
  const showLogo = computed(() => site.branding.show_header && !!site.branding.logo_url)
    ...
    <div class="app-header-inner">
      <div class="app-header-left">
        <BrandLogo
          ...
          size="sm"
        />
        <BrandMark size="sm" :linkable="auth.user?.home_page_enabled !== false" />
      ...
      <div class="app-header-right">
        ...
        <div ref="menuRoot" class="user-menu">
          ...
          <div v-if="menuOpen" class="user-pop" role="menu">
            ...
            <button
              type="button"
              class="user-pop-item user-pop-danger"
              role="menuitem"
              @click="doLogout"
            >
              {{ $t('header.logout') }}
