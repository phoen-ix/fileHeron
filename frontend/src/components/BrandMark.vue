...
<template>
  ...
  >
    <span class="brand-fix">file</span><span class="brand-colon" aria-hidden="true">:</span
    ><span class="brand-fix">Heron</span>
  </RouterLink>
  <span v-else class="brand brand-static" :data-size="size ?? 'md'" aria-label="file:Heron">
    <span class="brand-fix">file</span><span class="brand-colon" aria-hidden="true">:</span
    ><span class="brand-fix">Heron</span>
  </span>
</template>
