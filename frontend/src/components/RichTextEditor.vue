  ...
  <div class="rt-editor" :class="{ disabled }">
    ...
    <div class="rt-toolbar" role="toolbar" :aria-label="ariaLabel || undefined">
      ...
      <select
        class="rt-select"
        :disabled="disabled"
        :title="t('richtext.block')"
        :aria-label="t('richtext.block')"
        :value="''"
        @change="onBlockSelect"
      >
      ...
      <button
        ...
        class="rt-tool"
        :disabled="disabled"
        :title="t('richtext.align_left')"
        :aria-label="t('richtext.align_left')"
        @click="run(setAlign('left'))"
      >
        ⯇
      </button>
      <button
        ...
        class="rt-tool"
        :disabled="disabled"
        :title="t('richtext.align_center')"
        :aria-label="t('richtext.align_center')"
        @click="run(setAlign('center'))"
      >
        ≡
      </button>
      <button
        ...
        class="rt-tool"
        :disabled="disabled"
        :title="t('richtext.align_right')"
        :aria-label="t('richtext.align_right')"
        @click="run(setAlign('right'))"
      >
        ⯈
      </button>
      <button
        ...
        class="rt-tool"
        :disabled="disabled"
        :title="t('richtext.align_justify')"
        :aria-label="t('richtext.align_justify')"
        @click="run(setAlign('justify'))"
      >
        ☰
      </button>
      <span class="rt-sep" />
      ...
      <button
        ...
        @click="run(wrapInList(schema.nodes.bullet_list))"
      >
        •
      </button>
      <button
        ...
        class="rt-tool"
        :disabled="disabled"
        :title="t('richtext.ordered_list')"
        :aria-label="t('richtext.ordered_list')"
        @click="run(wrapInList(schema.nodes.ordered_list))"
      >
        1.
      </button>
      <button
        ...
        @click="run(wrapIn(schema.nodes.blockquote))"
      >
        ❝
      </button>
      <button
        ...
        class="rt-tool"
        :disabled="disabled"
        :title="t('richtext.code_block')"
        :aria-label="t('richtext.code_block')"
        @click="run(setBlockType(schema.nodes.code_block))"
      >
        { }
      </button>
      <button
      ...
      <button
        ...
        class="rt-tool"
        :disabled="disabled"
        :title="t('richtext.row_after')"
        :aria-label="t('richtext.row_after')"
      ...
      <button
        ...
        class="rt-tool"
        :disabled="disabled"
        :title="t('richtext.col_after')"
        :aria-label="t('richtext.col_after')"
      ...
      <button
        ...
        class="rt-tool"
        :disabled="disabled"
        :title="t('richtext.del_row')"
        :aria-label="t('richtext.del_row')"
        @click="run(deleteRow)"
      >
        −R
      </button>
      <button
        ...
        class="rt-tool"
        :disabled="disabled"
        :title="t('richtext.del_col')"
        :aria-label="t('richtext.del_col')"
      ...
      <button
        ...
        class="rt-tool"
        :disabled="disabled"
        :title="t('richtext.del_table')"
        :aria-label="t('richtext.del_table')"
      ...
      <template v-if="placeholders.length > 0">
        ...
        <select
          class="rt-select rt-placeholder"
          :disabled="disabled"
          :value="''"
...
<script setup lang="ts">
  ...
  function onLink() {
    ...
    if (href === null) return
    if (href === '')
      run(toggleMark(schema.marks.link)) // empty clears
