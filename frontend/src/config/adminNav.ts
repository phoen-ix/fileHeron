...
export const ADMIN_NAV: AdminNavCategory[] = [
  {
    ...
    items: [
      ...
      { routeName: 'admin-settings-api-tokens', labelKey: 'admin.nav.api_token_policy', matchNames: ['admin-settings-api-tokens'] },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { routeName: 'admin-settings-quarantine', labelKey: 'admin.nav.quarantine_alerts', matchNames: ['admin-settings-quarantine'] },
  ...
  },
  {
    ...
    items: [
      ...
      { routeName: 'admin-settings-error-alerts', labelKey: 'admin.nav.error_alerts', matchNames: ['admin-settings-error-alerts'] },
      ...
      { routeName: 'admin-settings-scan-guard', labelKey: 'admin.nav.scan_guard', matchNames: ['admin-settings-scan-guard'] },
