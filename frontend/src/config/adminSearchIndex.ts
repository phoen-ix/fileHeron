...
export const ADMIN_SEARCH_INDEX: readonly AdminSearchEntry[] = [
  ...
  // --- Advanced (admin-settings-advanced): group headings, no hash
  { routeName: 'admin-settings-advanced', labelKey: 'admin_advanced.groups.sessions', keywords: ['session', 'jwt', 'token lifetime', 'sitzung', 'login duration', 'authentication'] },
  { routeName: 'admin-settings-advanced', labelKey: 'admin_advanced.groups.rate_limits', keywords: ['lockout', 'locked out', 'gesperrt', 'brute force', 'rate limit', 'throttle', 'kontosperre'] },
  ...
  { routeName: 'admin-settings-advanced', labelKey: 'admin_advanced.groups.uploads', keywords: ['upload limit', 'max upload', 'direct upload', 'upload size'] },
  { routeName: 'admin-settings-advanced', labelKey: 'admin_advanced.groups.downloads', keywords: ['download link', 'signed url', 'resume', 'download settings'] },
  { routeName: 'admin-settings-advanced', labelKey: 'admin_advanced.groups.security', keywords: ['hibp', 'pwned', 'password check', 'sicherheit'] },
  { routeName: 'admin-settings-advanced', labelKey: 'admin_advanced.groups.branding', keywords: ['app name', 'brand name', 'product name', 'anwendungsname'] },
  ...
  { routeName: 'admin-settings-advanced', labelKey: 'admin_advanced.groups.anomaly', keywords: ['anomaly', 'suspicious activity', 'mass download', 'impossible travel', 'anomalie'] },
  { routeName: 'admin-settings-advanced', labelKey: 'admin_advanced.groups.updates', keywords: ['drain', 'postpone update', 'update wait', 'self-update'] },
  { routeName: 'admin-settings-advanced', labelKey: 'admin_advanced.groups.error_alert', keywords: ['cooldown', 'flood', 'error email cap', '4xx capture rate', 'alert throttle'] },
  ...
  { routeName: 'admin-settings-advanced', hash: '#tunable-auth.access_token_expire_minutes', labelKey: 'admin_advanced.keys.auth.access_token_expire_minutes', keywords: ['jwt', 'access token', 'session length', 'token ttl', 'sitzung', 'revoke window'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-auth.refresh_token_expire_days', labelKey: 'admin_advanced.keys.auth.refresh_token_expire_days', keywords: ['refresh token', 'stay signed in', 'remember me', 'session expiry', 'sitzungsdauer'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-auth.max_active_sessions_per_user', labelKey: 'admin_advanced.keys.auth.max_active_sessions_per_user', keywords: ['session cap', 'concurrent sessions', 'devices', 'max sessions', 'geräte'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-rate_limit.login', labelKey: 'admin_advanced.keys.rate_limit.login', keywords: ['login attempts', 'per ip', 'rate limit', 'anmeldeversuche', '429'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-rate_limit.register', labelKey: 'admin_advanced.keys.rate_limit.register', keywords: ['register limit', 'forgot password limit', 'invite rate limit', 'reset limit'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-rate_limit.login_window_sec', labelKey: 'admin_advanced.keys.rate_limit.login_window_sec', keywords: ['rate limit window', 'sliding window', 'zeitfenster'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-rate_limit.lockout_threshold', labelKey: 'admin_advanced.keys.rate_limit.lockout_threshold', keywords: ['lockout', 'locked out', 'gesperrt', 'failed logins', 'account lock', 'kontosperre'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-rate_limit.lockout_duration_min', labelKey: 'admin_advanced.keys.rate_limit.lockout_duration_min', keywords: ['lockout', 'locked out', 'gesperrt', 'lock duration', 'sperrdauer', 'unlock'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-public_link.password_rate_limit', labelKey: 'admin_advanced.keys.public_link.password_rate_limit', keywords: ['public link password attempts', 'link password guessing', 'brute force link'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-public_link.password_window_sec', labelKey: 'admin_advanced.keys.public_link.password_window_sec', keywords: ['public link password window', 'link attempts window'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-public_link.lockout_sec', labelKey: 'admin_advanced.keys.public_link.lockout_sec', keywords: ['public link lock', 'link locked', 'link lockout', 'link gesperrt'] },
  ...
  { routeName: 'admin-settings-advanced', hash: '#tunable-error_log.retention_days', labelKey: 'admin_advanced.keys.error_log.retention_days', keywords: ['error log retention', 'prune errors', 'error history'] },
  ...
  { routeName: 'admin-settings-advanced', hash: '#tunable-uploads.max_direct_bytes', labelKey: 'admin_advanced.keys.uploads.max_direct_bytes', keywords: ['upload limit', 'max upload', 'direct upload', '100 mb', 'multipart', 'upload size', 'uploadgröße'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-downloads.signed_url_ttl_sec', labelKey: 'admin_advanced.keys.downloads.signed_url_ttl_sec', keywords: ['download link expiry', 'signed url', 'download url lifetime', 'link ttl', 'resume'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-downloads.resume_credit_hours', labelKey: 'admin_advanced.keys.downloads.resume_credit_hours', keywords: ['resume', 'partial download', 'range', 'download budget', 'continue download', 'fortsetzen'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-updates.drain_max_wait_min', labelKey: 'admin_advanced.keys.updates.drain_max_wait_min', keywords: ['drain', 'postpone update', 'wait for transfers', 'maintenance wait', 'update delay'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-security.hibp_enabled', labelKey: 'admin_advanced.keys.security.hibp_enabled', keywords: ['hibp', 'pwned', 'breach', 'leaked password', 'have i been pwned', 'password check', 'kompromittiert'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-branding.app_name', labelKey: 'admin_advanced.keys.branding.app_name', keywords: ['app name', 'brand name', 'product name', 'anwendungsname', 'title'] },
  ...
  { routeName: 'admin-settings-advanced', hash: '#tunable-anomaly.enabled', labelKey: 'admin_advanced.keys.anomaly.enabled', keywords: ['anomaly', 'anomalie', 'suspicious', 'heuristics', 'detection'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-anomaly.mass_download_threshold', labelKey: 'admin_advanced.keys.anomaly.mass_download_threshold', keywords: ['mass download', 'bulk download', 'exfiltration', 'massendownload'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-anomaly.multi_network_threshold', labelKey: 'admin_advanced.keys.anomaly.multi_network_threshold', keywords: ['impossible travel', 'multiple networks', 'account sharing', 'distinct networks'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-anomaly.login_failure_threshold', labelKey: 'admin_advanced.keys.anomaly.login_failure_threshold', keywords: ['login failures', 'credential stuffing', 'brute force alert', 'anmeldefehler'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-error_alert.cooldown_minutes', labelKey: 'admin_advanced.keys.error_alert.cooldown_minutes', keywords: ['cooldown', 'flood', 'throttle', 'too many emails', 'dedup', 'abkühlung'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-error_alert.max_per_hour', labelKey: 'admin_advanced.keys.error_alert.max_per_hour', keywords: ['flood', 'throttle', 'too many emails', 'email cap', 'max alerts', 'hourly cap'] },
  { routeName: 'admin-settings-advanced', hash: '#tunable-error_log.scan_capture_per_min', labelKey: 'admin_advanced.keys.error_log.scan_capture_per_min', keywords: ['4xx capture', 'scan capture', '404 logging rate', 'scanner logging'] },
]
