  ...
  <div class="fh-page" data-density="operator">
    ...
    <div class="filters">
      <input
        ...
        :placeholder="t('admin_audit.filter.event_type')"
        :aria-label="t('admin_audit.filter.event_type')"
      />
      <input
        v-model.trim="targetType"
        class="fh-field-input"
        :placeholder="t('admin_audit.filter.target_type')"
        :aria-label="t('admin_audit.filter.target_type')"
      />
      <input
        v-model.trim="targetId"
        class="fh-field-input"
        :placeholder="t('admin_audit.filter.target_id')"
      ...
      <input
        ...
        class="fh-field-input"
        type="datetime-local"
        :title="t('admin_audit.filter.from')"
        ...
        <tbody>
          <template v-for="r in items" :key="r.id">
            <tr>
              ...
              <td>
                <span class="fh-mono ev">{{ r.event_type }}</span>
              </td>
              <td class="actor-cell">
                <template v-if="r.actor_user_id !== null">
                  <RouterLink
                    ...
                    class="actor-link"
                  >
                    <span v-if="r.actor_display_name" class="actor-name">{{
