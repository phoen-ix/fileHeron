  ...
  <div class="email-page" data-density="operator">
    ...
    <template v-else-if="current">
      <div class="status-row">
        <span class="fh-pill" :data-state="current.is_configured ? 'active' : undefined">
          {{
      ...
      <form class="email-form" @submit.prevent="onSave">
        ...
        <label class="fh-field">
          ...
          <input v-model.trim="form.from_name" class="fh-field-input" type="text" maxlength="120" />
        </label>
      ...
      <section class="test-section">
        ...
        <div class="test-row">
          <input
            ...
            :disabled="testing"
          />
          <button type="button" class="fh-btn" :disabled="testing || authBlocked" @click="onTest">
        ...
        <div v-if="testResult" class="fh-notice" :data-tone="testResult.ok ? 'success' : 'error'">
          ...
          <div v-if="!testResult.ok" class="test-detail fh-mono">
            ...
            <div v-if="testResult.smtp_code !== null">SMTP {{ testResult.smtp_code }}</div>
