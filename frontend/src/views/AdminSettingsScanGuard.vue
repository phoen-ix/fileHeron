<script setup lang="ts">
  ...
  const validationError = computed<string | null>(() => {
    ...
    if (maxBlockMinutes.value < blockMinutes.value) return t('admin_scan_guard.err_max_below_base')
    return null
  })
    ...
    <form v-else class="policy-form" @submit.prevent="onSave">
      <fieldset class="toggle-fieldset">
        ...
        <label class="toggle">
          ...
          <span
            ><strong>{{ t('admin_scan_guard.enabled_label') }}</strong></span
          >
        </label>
        ...
        <label class="toggle">
          ...
          <span
            ><strong>{{ t('admin_scan_guard.watchlist_label') }}</strong></span
          >
        </label>
      ...
      <fieldset class="toggle-fieldset">
        ...
        <label class="toggle">
          ...
          <span
            ><strong>{{ t('admin_scan_guard.probe_path_label') }}</strong></span
          >
        </label>
        ...
        <label class="toggle">
          ...
          <span
            ><strong>{{ t('admin_scan_guard.api_404_label') }}</strong></span
          >
        </label>
        ...
        <label class="toggle">
          ...
          <span
            ><strong>{{ t('admin_scan_guard.auth_failure_label') }}</strong></span
          >
        </label>
        ...
        <label v-if="signalAuthFailure" class="num-field">
          ...
          <input v-model.number="authThreshold" type="number" class="fh-input" min="5" max="500" />
        </label>
      ...
      <fieldset class="toggle-fieldset">
        ...
        <label class="num-field">
          ...
          <input
            v-model.number="maxBlockMinutes"
            type="number"
            class="fh-input"
            min="1"
            max="43200"
        ...
        <label class="toggle">
          ...
          <span
            ><strong>{{ t('admin_scan_guard.escalation_label') }}</strong></span
          >
        </label>
        ...
        <label v-if="signalApi404" class="num-field">
          ...
          <input
            v-model.number="minDistinctPaths"
            type="number"
            class="fh-input"
            min="1"
            max="500"
      ...
      <fieldset class="toggle-fieldset">
        ...
        <label class="toggle">
          ...
          <span
            ><strong>{{ t('admin_scan_guard.network_label') }}</strong></span
          >
        </label>
        ...
        <template v-if="networkEscalation">
          ...
          <label class="num-field">
            ...
            <input
              v-model.number="networkLookbackHours"
              type="number"
              class="fh-input"
              min="1"
              max="8760"
          ...
          <label class="num-field">
            ...
            <input
              v-model.number="networkPrefixV6"
              type="number"
              class="fh-input"
              min="56"
              max="128"
