  ...
  <div class="fh-prose twofa">
    ...
    <section v-else-if="stage === 'active' && status" class="active-step">
      ...
      <form class="manage-form" @submit.prevent="regenerateCodes">
        <div class="fh-field">
          <label class="fh-field-label" for="regen-password">{{
        ...
        <div class="fh-field">
          <label class="fh-field-label" for="regen-code">{{
            $t('twofa.code_or_recovery_label')
          }}</label>
          <input
            id="regen-code"
            v-model="disableCode"
    ...
    <section v-else-if="stage === 'disable'" class="active-step">
      ...
      <form class="manage-form" @submit.prevent="disable">
        <div class="fh-field">
          <label class="fh-field-label" for="disable-password">{{
            $t('common.current_password')
          }}</label>
          <input
            id="disable-password"
        ...
        <div class="fh-field">
          <label class="fh-field-label" for="disable-code">{{
            $t('twofa.code_or_recovery_label')
          }}</label>
          <input
            id="disable-code"
    ...
    <div v-else-if="error" class="fh-notice" role="alert" data-tone="error">
      {{ error }}
      <button type="button" class="fh-btn-text" @click="retryStatus">
        {{ $t('common.retry') }}
      </button>
    </div>
